...
layout: page
title: Unsere Regeln
permalink: /gruppenregeln/
---

_Gruppenregeln sind wie Beipackzettel für Medikamente:_
...
### Rücksicht auf psychisches Befinden {#psychisches-befinden}
...
Wenn man auch eine Trigger-Wirkung bei keinem Thema vollkommen ausschließen kann, so gibt es doch einige Bereiche, in denen sie sehr wahrscheinlich sind. 
Diese Bereiche sind:
