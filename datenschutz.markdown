...
Im Falle datenschutzrechtlicher Verstöße steht dem Betroffenen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. Zuständig ist der Landesdatenschutzbeauftragte des Bundeslandes, in dem unsere Initiative ihren Sitz hat (hier: Schleswig-Holstein).
...
**Hinweis zu GitHub Pages:** Da diese Website auf GitHub Pages gehostet wird, werden Daten in die USA übertragen. GitHub ist unter dem EU-US Data Privacy Framework zertifiziert.
...
## 4. Besondere Daten (Gesundheitsdaten)
Da unsere Initiative Themen im Bereich Autismus und ADHS behandelt, weisen wir darauf hin, dass die Übermittlung von Informationen über Ihre Gesundheit (z.B. Diagnosen) auf freiwilliger Basis erfolgt. Wir speichern solche Daten nur, wenn dies zur Erfüllung unseres Zwecks (Selbsthilfe/Beratung) absolut notwendig ist und Sie explizit eingewilligt haben.
